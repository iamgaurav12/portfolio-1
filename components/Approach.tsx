    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        <Card
          ...
          des="We’ll work closely to define your website’s goals, user needs, and essential features. This phase lays the foundation for the site structure, navigation flow, and content strategy."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          des="With the plan in place, I begin building your website while keeping you in the loop at every stage. Expect regular progress updates and collaborative feedback to ensure your vision comes to life."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          title="Final Build & Launch"
          icon={<AceternityIcon order="Phase 3" />}
          des="This is the big moment! I’ll finalize your website, run tests to ensure optimal performance, and deploy it for the world to see. Post-launch, I’ll ensure everything runs smoothly."
        >
          <CanvasRevealEffect
            animationSpeed={3}
